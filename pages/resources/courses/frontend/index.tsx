    ...
    <div className={`${geistSans.variable} min-h-screen bg-gray-50 font-sans`}>
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <span className="text-gray-900">Frontend Mastery</span>
        </div>
        ...
        <div className="mb-10">
          ...
          <p className="text-lg text-gray-600">
            A focused path for modern UI engineering, personalized for {displayName}.
          </p>
        </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        router.push(`/resources/courses/frontend/${course.id}`)
                      }
                    >
...
export default withAuth(FrontendCoursesPage)
