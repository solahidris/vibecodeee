...
function FoundationCoursePage() {
  ...
  useEffect(() => {
    ...
    const nextProgressData = {
      ...progressData,
      foundation: nextFoundationProgress,
    }
      ...
      <div className={`${geistSans.variable} min-h-screen bg-gray-50 font-sans`}>
        ...
        <main className="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-16 sm:px-6 lg:px-8">
          <Card hover={false}>
            ...
            <p className="mt-2 text-gray-600">
              We could not find that course. Head back to the Foundations lane
...
export default withAuth(FoundationCoursePage)
