...
function CareerDevopsCoursePage() {
  ...
  useEffect(() => {
    ...
    const nextProgressData = {
      ...progressData,
      careerDevops: nextCareerProgress,
    }
        ...
        <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
          <Card className="p-8">
            ...
            <p className="mt-3 text-gray-600">
              We could not find that course. Head back to the Career, DevOps &amp; Pro
              Skills lane to choose another.
            </p>
            <Button
              variant="secondary"
              size="md"
            ...
            >
              Back to Career, DevOps &amp; Pro Skills
            </Button>
          </Card>
        </main>
      </div>
                ...
                <div className="grid gap-6 lg:grid-cols-[1.3fr_1fr]">
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className={cn(
                        'mt-3 w-full rounded-2xl border px-4 py-3 text-sm text-gray-700 shadow-sm outline-none transition',
                        isPassed
...
export default withAuth(CareerDevopsCoursePage)
