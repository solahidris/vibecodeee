...
function AiDataScienceCoursesPage() {
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-lg text-gray-600">
            Practical AI workflows and ML fundamentals, personalized for {displayName}.
          </p>
        </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/resources/courses/ai-data-science/${course.id}`
                        )
                      }
                    >
...
export default withAuth(AiDataScienceCoursesPage)
