      ...
      <div className={`${geistSans.variable} min-h-screen bg-white font-sans`}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="mb-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 flex h-10 w-10 items-center justify-center rounded-xl border-2 border-zinc-900">
          ...
          <div className="lg:sticky lg:top-24">
            <div className="rounded-3xl border-2 border-zinc-900 bg-zinc-900 p-10 shadow-2xl">
              {/* Badge */}
              ...
              <div className="mb-8">
                <div className="mb-2 flex items-baseline gap-2">
                  <span className="text-6xl font-black text-white">RM10</span>
                  <span className="text-xl text-zinc-300">/month</span>
                </div>
                <p className="text-sm text-zinc-400">Less than a cup of coffee per day</p>
              </div>
              ...
              <div className="mb-8 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-zinc-200">Unlimited access to all channels</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 flex-shrink-0 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-zinc-200">Premium resources library</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 flex-shrink-0 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-zinc-200">Daily job opportunities</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 flex-shrink-0 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-zinc-200">AI prompt templates</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 flex-shrink-0 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-zinc-200">Expert mentorship access</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="h-5 w-5 flex-shrink-0 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-zinc-200">Monthly live webinars</span>
                </div>
              </div>

              {/* Error Message */}
              {error && (
                <div className="mb-6 rounded-xl border border-red-400 bg-red-500/10 p-4">
              ...
              <button
                ...
                disabled={loading}
                className="group w-full inline-flex items-center justify-center gap-3 rounded-2xl bg-white px-8 py-5 text-lg font-bold text-zinc-900 shadow-xl transition-all duration-300 hover:scale-105 hover:bg-zinc-100 hover:shadow-2xl cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mb-4"
              >
                {loading ? (
                  <>
