...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-zinc-200/50 bg-white/60 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4 flex items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl overflow-hidden transition-all duration-300 hover:scale-110">
                <Image
          ...
          <div>
            <h3
              className="text-sm font-bold uppercase tracking-wider text-zinc-900"
        ...
        <div className="mt-12 border-t border-zinc-200 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <p className="text-sm text-zinc-500">Crafted with precision</p>
          </div>
        </div>
      </div>
    </footer>
